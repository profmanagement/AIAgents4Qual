        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <p className="text-2xl font-bold text-blue-600">31. Dezember 2025</p>
            </div>
            <div className="card text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Paper decision released</h3>
              <p className="text-2xl font-bold text-blue-600">19. Januar 2026</p>
            </div>
            <div className="card text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Virtual Conference</h3>
              <p className="text-2xl font-bold text-blue-600">12. Februar 2026</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8 text-center">
              agents4science 2026 will be a one-day virtual conference featuring:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="card text-center">
